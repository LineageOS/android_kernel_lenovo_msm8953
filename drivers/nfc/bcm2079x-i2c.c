				  ...
				  size_t count, loff_t *offset)
{
	...
	**/
	...
	dev_info(&bcm2079x_dev->client->dev,"bcm2079x_dev_read, count = %d, total = %d, count_irq = %d \n", (int)count, total, bcm2079x_dev->count_irq);
				   ...
				   size_t count, loff_t *offset)
{
	...
	dev_info(&bcm2079x_dev->client->dev,"bcm2079x_dev_write, count = %d, ret = %d\n", (int)count, ret);
					 ...
					 unsigned int cmd, unsigned long arg)
{
	struct bcm2079x_dev *bcm2079x_dev = filp->private_data;
        ...
        dev_info(&bcm2079x_dev->client->dev,"bcm2079x_dev_unlocked_ioctl, cmd = %d \n", cmd);
			   ...
			   const struct i2c_device_id *id)
{
	...
	bcm2079x_dev->bcm2079x_device.minor = NFC_MINOR;
